...
namespace WorkflowDemo {
    ...
    public partial class LeaveActivity : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(LeaveActivity).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(LeaveActivity));
        ...
        private string FindResource() {
            string[] resources = typeof(LeaveActivity).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".LeaveActivity.g.xaml") || resource.Equals("LeaveActivity.g.xaml"))) {
                    return resource;
                }
            }
