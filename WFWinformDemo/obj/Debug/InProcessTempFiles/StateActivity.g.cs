...
namespace WFWinformDemo {
    ...
    public partial class StateActivity : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(StateActivity).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(StateActivity));
        ...
        private string FindResource() {
            string[] resources = typeof(StateActivity).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".StateActivity.g.xaml") || resource.Equals("StateActivity.g.xaml"))) {
                    return resource;
                }
            }
