...
namespace WFWinformDemo {
    ...
    public partial class StateMoneyActivity : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(StateMoneyActivity).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(StateMoneyActivity));
        ...
        private string FindResource() {
            string[] resources = typeof(StateMoneyActivity).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".StateMoneyActivity.g.xaml") || resource.Equals("StateMoneyActivity.g.xaml"))) {
                    return resource;
                }
            }
