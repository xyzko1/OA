...
namespace WFWinformDemo {
    ...
    public partial class DemoActivity : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(DemoActivity).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(DemoActivity));
        ...
        private string FindResource() {
            string[] resources = typeof(DemoActivity).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".DemoActivity.g.xaml") || resource.Equals("DemoActivity.g.xaml"))) {
                    return resource;
                }
            }
